...
import { CssIcon, HtmlIcon, JavascriptIcon, ReactIcon, ReduxIcon, TypescriptIcon } from "@/constants/image";
...
const techs = [
  ...
  <TypescriptIcon key="ts" className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12" />,
  ...
  <JavascriptIcon key="js" className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12" />,
      ...
      <div className="flex flex-col lg:flex-row gap-8 md:gap-16 h-[400px]">
        ...
        <div className="flex flex-col lg:justify-between h-full text-center lg:text-left">
          <p className="text-xl text-gray-400 leading-relaxed mb-6">
            Front-End Developer with 3+ years of experience using React and TypeScript. Passionate about clean, maintainable UI
            and micro front-end architectures. Based in Milan, Italy 🇮🇹.
          </p>
          <div>
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-10 mb-4">
              {techs.map((icon) => icon)} <p className="text-xs text-center w-full">... and more on my resume</p>
            </div>
          </div>
        </div>
      </div>
